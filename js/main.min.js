...
document.addEventListener("DOMContentLoaded",function(e){}),window.onload=()=>{const d=document.querySelectorAll(".dropdown_show"),m=document.querySelectorAll(".dropdown_menu");d.forEach(e=>{e.addEventListener("mouseenter",e=>{e.target.lastElementChild.classList.add("active")})}),window.addEventListener("mouseover",e=>{e.target.matches(".dropdown_show")||e.target.matches(".dropdown_menu")||e.target.matches(".header__link")||m.forEach(e=>{e.classList.remove("active")})});new Swiper(".swiper",{loop:!0,navigation:{nextEl:".intro__next",prevEl:".intro__prev"}}),new Swiper(".swiper",{loop:!0,navigation:{nextEl:".reviews__next",prevEl:".reviews__prev"},pagination:{el:".reviews__pagination",type:"bullets",bulletClass:"reviews__dot",bulletActiveClass:"reviews__dot-active",clickable:"true"}});const e=document.querySelector(".fixed"),u=document.querySelector(".fixed__toTop");var a=document.querySelector(".header"),v=document.querySelector(".intro");let p=a.offsetHeight+v.offsetHeight;window.addEventListener("scroll",function(){this.scrollY>p?e.classList.add("show"):e.classList.remove("show")}),u.addEventListener("click",()=>{const e=document.getElementById("top");var a=e.getBoundingClientRect().top;window.scrollBy({top:a,behavior:"smooth"})});const t=document.querySelector("body"),g=document.querySelector(".fixed__showField"),r=document.querySelector(".fixed__feedback"),l=document.querySelector(".fixed__bg"),L=document.querySelector(".fixed__close");g.addEventListener("click",()=>{t.classList.add("lock"),r.classList.add("active"),l.classList.add("active")}),L.addEventListener("click",()=>{t.classList.remove("lock"),r.classList.remove("active"),l.classList.remove("active")});var o;let h=new IntersectionObserver(function(e){e.forEach(e=>{e.isIntersecting&&e.target.classList.add("element-show")})},{threshold:[.5]});for(o of document.querySelectorAll(".element-animation"))h.observe(o);const _=document.querySelector(".header__search"),y=document.querySelector(".header__search-small"),E=document.querySelector(".header__search-frame"),f=document.querySelector(".header__search-closer"),w=document.querySelector(".header__search-input");a=()=>{E.classList.add("active"),t.classList.add("lock"),i.classList.contains("active")&&s.forEach(e=>{e.lastElementChild.style.maxHeight=null}),i.classList.remove("active"),c.classList.remove("active"),window.addEventListener("keydown",e=>{"Escape"===e.code&&A()})};const A=()=>{E.classList.remove("active"),t.classList.remove("lock"),w.value="",i.classList.remove("active"),c.classList.remove("active")},C=(_.addEventListener("click",a),y.addEventListener("click",a),f.addEventListener("click",A),document.querySelectorAll(".header__search-category")),i=(C.forEach(e=>{e.addEventListener("click",()=>{e.classList.contains("active")||(C.forEach(e=>{e.classList.remove("active")}),e.classList.add("active"))})}),document.querySelector(".header__burger")),c=document.querySelector(".burger__nav");i.addEventListener("click",()=>{i.classList.contains("active")&&s.forEach(e=>{e.lastElementChild.style.maxHeight=null}),i.classList.toggle("active"),c.classList.toggle("active"),t.classList.toggle("lock")});let s=document.querySelectorAll(".acc");s.forEach(e=>{e.addEventListener("click",e=>{let a=e.target.nextElementSibling;a.style.maxHeight?a.style.maxHeight=null:a.style.maxHeight=a.scrollHeight+"px"})});const S=document.querySelectorAll(".reviews__preview"),n=document.querySelector(".reviews__fullscreen"),x=document.querySelector(".reviews__fullscreen-img"),k=e=>{e.code="Escape",n.classList.remove("active"),t.classList.remove("lock"),window.removeEventListener("keydown",k)};S.forEach(e=>{e.addEventListener("click",e=>{let a=e.target.closest(".reviews__preview");e=a.firstElementChild.firstElementChild.getAttribute("src");x.setAttribute("src",e),n.classList.add("active"),t.classList.add("lock"),window.addEventListener("keydown",k)})}),n.addEventListener("click",e=>{e.target.classList.contains("reviews__fullscreen-img")||(n.classList.remove("active"),t.classList.remove("lock"))})};const allVisibleForms=document.querySelectorAll(".feedback__form"),fixedForm=(allVisibleForms.forEach(a=>{a.addEventListener("submit",e=>{e.preventDefault(),a.elements.name.validity.valid||a.elements.phone.validity.valid?a.elements.name.validity.valid?a.elements.phone.validity.valid?(new FormData(a),a.reset(),a.innerHTML="",a.previousElementSibling.textContent="Спасибо, ваша заявка отправлена. Наш менеджер свяжется с вами в ближайшее время!"):(a.firstElementChild.classList.add("show"),a.children[2].classList.add("error")):(a.firstElementChild.classList.add("show"),a.children[1].classList.add("error")):(a.firstElementChild.classList.add("show"),a.children[1].classList.add("error"),a.children[2].classList.add("error"))})}),document.querySelector(".fixed__form")),feedbackNameAll=(fixedForm.addEventListener("submit",e=>{e.preventDefault(),fixedForm.elements.name.validity.valid||fixedForm.elements.phone.validity.valid?fixedForm.elements.name.validity.valid?fixedForm.elements.phone.validity.valid?(new FormData(fixedForm),fixedForm.reset(),fixedForm.innerHTML='<p class="fixed__after">Спасибо, ваша заявка отправлена.<br>Наш менеджер свяжется с вами в ближайшее время!</p><input type="submit" class="fixed__submit btn__yellow btn__link" value="Отправить" name="submit">'):(fixedForm.firstElementChild.classList.add("show"),fixedForm.children[2].classList.add("error")):(fixedForm.firstElementChild.classList.add("show"),fixedForm.children[1].classList.add("error")):(fixedForm.firstElementChild.classList.add("show"),fixedForm.children[1].classList.add("error"),fixedForm.children[2].classList.add("error"))}),document.querySelectorAll(".feedback__name")),feedbackPhoneAll=document.querySelectorAll(".feedback__phone"),removeOnFocus=a=>{a.addEventListener("input",e=>{a.parentElement.classList.remove("error"),a.parentElement.parentElement.children[0].classList.remove("show")})},catalogWrapper=(feedbackNameAll.forEach(removeOnFocus),feedbackPhoneAll.forEach(removeOnFocus),document.querySelector(".catalog__wrapper"));let counter=0,data={excavator:[{imgName:"1.jpg",header:"Аренда экскаваторов CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:150,popularity:1},{imgName:"1.jpg",header:"Аренда экскаваторов CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:200,popularity:1},{imgName:"1.jpg",header:"Аренда экскаваторов CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:130,popularity:2},{imgName:"1.jpg",header:"Аренда экскаваторов CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:1}],tipper:[{imgName:"2.jpg",header:"Аренда самосвалов CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:150,popularity:1},{imgName:"2.jpg",header:"Аренда самосвалов CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:2}],dozer:[{imgName:"3.jpg",header:"Аренда бульдозеров CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:1}],digger:[{imgName:"4.jpg",header:"Аренда экскаваторов CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:1}],loader:[{imgName:"5.jpg",header:"Аренда погрузчиков CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:1}],fLoader:[{imgName:"6.jpg",header:"Аренда фронтальных погрузчиков CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:1}],wheelDigger:[{imgName:"7.jpg",header:"Аренда колёсных экскаваторов CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:1}],flail:[{imgName:"8.jpg",header:"Аренда тралов CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:1}],truck:[{imgName:"9.jpg",header:"Аренда грунтовых катков CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:1}],crane:[{imgName:"10.jpg",header:"Аренда автокранов CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:1}],grader:[{imgName:"11.jpg",header:"Аренда автогрейдеров CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:1}],telescopicLoader:[{imgName:"12.jpg",header:"Аренда телескопических погрузчиков CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:1}],mini:[{imgName:"13.jpg",header:"Аренда мини-техники CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:1}],hydraulicHammer:[{imgName:"14.jpg",header:"Аренда гидромолотов CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:1}],drillingEquipment:[{imgName:"15.jpg",header:"Аренда буровой техники CATERPILLAR",name1:"Объём фронтального ковша",value1:"1,3 м3",name2:"Высота выгрузки",value2:"2690 мм",name3:"Мощность двигателя",value3:"100 л.с.",price:100,popularity:2}]};const createElement=a=>{let t=[];for(let e=0;e<a.length;e++)t[e]=document.createElement("DIV"),t[e].classList.add("catalog__item"),t[e].innerHTML=`<a href="#" class="catalog__link"></a>

    <div class="catalog__img">
      <img src="./images/catalog/${a[e].imgName}" alt="экскаватор" />
    </div>

    <a href="#" class="catalog__button">Подробнее</a>

    <div class="catalog__info">
      <h4 class="catalog__header">${a[e].header}</h4>

      <div class="catalog__options">
        <div class="catalog__feature">
          <p class="catalog__name">${a[e].name1}</p>
          <p class="catalog__value">${a[e].value1}</p>
        </div>

        <div class="catalog__feature">
          <p class="catalog__name">${a[e].name2}</p>
          <p class="catalog__value">${a[e].value2}</p>
        </div>

        <div class="catalog__feature">
          <p class="catalog__name">${a[e].name3}</p>
          <p class="catalog__value">${a[e].value3}</p>
        </div>
      </div>

      <p class="catalog__price">${a[e].price} BYN</p>
    </div>`;return t},concatAllCategories=e=>{let a=[];for(var t in e)a=[...a,...e[t]];return a},switchCategory=(e,a)=>{let t=[];return t=e in a?[...a[e]]:concatAllCategories(a),t};let category="all",catalog=createElement(switchCategory(category,data));const catalolgCategories=document.querySelectorAll(".catalog__category"),compareMin=(e,a)=>e.price>a.price?1:e.price==a.price?0:e.price<a.price?-1:void 0,compareMax=(e,a)=>e.price<a.price?1:e.price==a.price?0:e.price>a.price?-1:void 0,sortByPopularity=(e,a)=>e.popularity<a.popularity?1:e.popularity==a.popularity?0:e.popularity>a.popularity?-1:void 0,sortCatalog=(e,a)=>"fromMaxToMin"===a?e.sort(compareMax):"fromMinToMax"===a?e.sort(compareMin):"popularity"===a?e.sort(sortByPopularity):switchCategory(category,data),catalogSort=document.querySelector(".catalog__sort"),catalogSortList=document.querySelector(".catalog__sort-list"),catalogSortItems=document.querySelectorAll(".catalog__sort-item"),catalogSortType=document.querySelector(".catalog__sort-type");let sortingType="start";const hideCatalogSortList=()=>{catalogSortList.classList.remove("active")};catalogSort.addEventListener("click",()=>{catalogSortList.classList.add("active")}),window.addEventListener("click",e=>{e.target.matches(".catalog__sort")||e.target.matches(".catalog__sort-list")||e.target.matches(".catalog__sort-type")||e.target.matches(".catalog__arrow")||hideCatalogSortList()}),catalogSortItems.forEach(e=>{e.addEventListener("click",e=>{catalogSortType.textContent=e.target.dataset.text,sortingType===e.target.dataset.type?hideCatalogSortList():(sortingType=e.target.dataset.type,hideCatalogSortList(),counter=0,catalogWrapper.innerHTML="",catalog=createElement(sortCatalog(switchCategory(category,data),sortingType)),addToPage(catalog))})}),catalolgCategories.forEach(e=>{e.addEventListener("click",e=>{catalolgCategories.forEach(e=>{e.classList.remove("active")}),e.target.classList.add("active"),category===e.target.dataset.type||(category=e.target.dataset.type,counter=0,catalogWrapper.innerHTML="",catalog=createElement(sortCatalog(switchCategory(category,data),sortingType)),addToPage(catalog))})});let cardsAmout=16;window.addEventListener("resize",()=>{cardsAmout=1279<document.documentElement.clientWidth?16:12});const addToPage=a=>{for(let e=counter;e<counter+cardsAmout;e++)void 0!==a[e]&&catalogWrapper.append(a[e]);counter+=cardsAmout},catalogMore=document.querySelector(".catalog__more");catalogMore.addEventListener("click",()=>{addToPage(catalog)}),window.addEventListener("load",()=>{cardsAmout=1279<document.documentElement.clientWidth?16:12,addToPage(createElement(switchCategory(category,data)))});